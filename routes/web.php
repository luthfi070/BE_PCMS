...
$router->group(['prefix' => 'api'], function () use ($router) {
    ...
    $router->get('/getOrInsertCurrencyByName', ['uses' => 'CurrencyController@getOrInsertCurrencyByName']);
    ...
    $router->get('/getOrInsertUnitBySymbol', ['uses' => 'UnitController@getOrInsertUnitBySymbol']);
