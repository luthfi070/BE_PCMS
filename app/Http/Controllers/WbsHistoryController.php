...
use App\Models\WbsHistory;

class WbsHistoryController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(WbsHistory $WbsHistory, $id)
    {
        //
    ...
    public function DataBoqByidHistory(WbsHistory $WbsHistory, $ProjectID, $contractorID, $created_at, $time_at)
    {
        //
    ...
    public function DataBoqchild(WbsHistory $WbsHistory, $id){
        return DB::select('SELECT a.*,c.UnitName,d.currencyName
         FROM history_boq a
         left JOIN unit c on c.id=a.unitID
         left JOIN currency d on d.id = a.CurrencyID
    ...
    public function DataBoqchildHistory (WbsHistory $WbsHistory, $id){
        return  DB::select('SELECT a.*,c.UnitName,d.currencyName
         FROM history_boq a
         left JOIN unit c on c.id=a.unitID
         left JOIN currency d on d.id = a.CurrencyID
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(WbsHistory $WbsHistory)
    {
        //
    }
    ...
    {
        //
        WbsHistory::where ('id',$id)->update($request->all());
